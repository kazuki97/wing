document.addEventListener('DOMContentLoaded', () => {
    ...
    function searchSalesByDateRange() {
    ...
    searchButton.addEventListener('click', searchSalesByMonth);
    rangeSearchButton.addEventListener('click', searchSalesByDateRange);
});
